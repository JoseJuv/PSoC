...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x48000924u)

/* UDB_1_0_0_CONFIG Address: CYDEV_UCFG_B1_P2_U0_BASE Size (bytes): 128 */
#define BS_UDB_1_0_0_CONFIG_VAL ((const uint8 CYFAR *)0x4800092Cu)
...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x480009B4u)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x480009C8u)
